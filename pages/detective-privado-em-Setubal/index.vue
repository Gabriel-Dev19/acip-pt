    ...
    <div class="container d-flex align-items-center row mx-auto">
      <div class="col-12 px-xs-0">
        <h2 class="d-flex py-0">
          <div class="bl-temas mr-10 my-1" /> Detetive particular em Setúbal
        </h2>
        <p class="fw-600 mt-4">
          Você está procurando um Detetive Particular em <b>Setúbal</b>?
          A ACIP DETETIVES PROFISSIONAIS está em <b>Setúbal</b> e teremos
      ...
      <section class="col-12 px-0">
        <div class="container px-xs-0">
          ...
          <div class="position-relative overflow-hidden mt-30 col-12 d-flex row mx-auto pr-0 pt-1 pb-10 pl-45">
            ...
            <a class="d-flex col-12 mt-4 px-0 py-0 text-preto-cidades fs-sm-17 fw-600 btn align-items-center" @click.prevent="Seixal">
              <i class="fa fa-circle fs-12 mr-2" /> Seixal
            </a>
...
export default {
  ...
  layout: 'LayoutPadrao',
  head: {
    title: 'Detetive particular em Setúbal | Balneário Camboriú | Joinville | Florianópolis | Curitiba | Tubarão | Rio do Sul'
  },
  methods: {
    Seixal () {
